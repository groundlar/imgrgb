...
public final class ColorDistanceMetrics {
    ...
    static float RGBChebychev(Color c1, Color c2) {
        float max = 0;
     ...
     * @return
     */
    static float sumRGBDist(Color c1, Color c2) {
        float ret = 0;
        for (float val : getRGBDists(c1, c2)){
            ret += val;
        }
    ...
    static float sumSqRGBDist(Color c1, Color c2) {
        float ret = 0;
        for (float val : getRGBDists(c1, c2)){
            ret += val*val;
        }
     ...
     * @return
     */
    static float sumCubeRGBDist(Color c1, Color c2) {
        float ret = 0;
        for (float val : getRGBDists(c1, c2)){
            ret += val*val*val;
        }
    ...
    static float sumQrtRGBDist(Color c1, Color c2) {
        float ret = 0;
        for (float val : getRGBDists(c1, c2)){
            ret += val*val*val*val;
        }
     ...
     * @return
     */
    static float cosineSqRGBDist(Color c1, Color c2) {
        float r1 = c1.getRed();
        float r2 = c2.getRed();
     ...
     * @return
     */
    static float sumHSBDist(Color c1, Color c2) {
        float ret = 0;
    ...
    static float sumSqSBDist(Color c1, Color c2) {
        float ret = 0;
        for (float val : getHSBDists(c1, c2)){
            ret += val*val;
        }
     ...
     * @return
     */
    static float sumCubeHSBDist(Color c1, Color c2) {
        float ret = 0;
        for (float val : getHSBDists(c1, c2)){
            ret += val*val*val;
        }
    ...
    static float sumQrtHSBDist(Color c1, Color c2) {
        float ret = 0;
        for (float val : getHSBDists(c1, c2)){
            ret += val*val*val*val;
        }
